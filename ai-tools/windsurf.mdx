...
Configure Windsurf's Cascade AI assistant to help you write and maintain documentation. This guide shows how to set up Windsurf specifically for your Ezaalah documentation workflow.
...
- This is a documentation project on the Ezaalah platform
